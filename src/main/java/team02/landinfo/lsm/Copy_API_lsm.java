...
public class Copy_API_lsm extends Using_API_KEY {
	String api_key;
	BufferedReader bf;
	String result;
	URL url;
	...
	private Copy_API_lsm() {

	}

	private static Copy_API_lsm instance = new Copy_API_lsm();

	public static Copy_API_lsm getInstance() {
		return instance;
	}
