...
<div class="main-wrapper">
  <div class="error">
    <p class="error__num">5</p>
    <div class="error__moon"></div>
    <p class="error__num">0</p>
  </div>
  <div class="house">
  ...
  <div class="button-container">
    <p>Sorry! That page dosen't seem to exist</p><a class="button button--back" href="/wherego/views/main/main.jsp">Go Back
      <div class="ghost">
